...
- Tone (`contentType`): tutorial/cookbook=instructional; concept/guide=explanatory; reference/faq=factual; benchmark=academic; rfc=engineering.
- Integrity: Cite sources. No secrets/policy violations.
