...
Fokus utamanya adalah menjawab dua pertanyaan besar: **Mengapa** Sprint ini penting, dan **Apa** yang bisa kita selesaikan. Pertanyaan "mengapa" dijawab oleh Product Owner, dengan menyampaikan nilai yang ingin dicapai. Lalu, tim berkolaborasi menentukan _Sprint Goal_ yang jelas – tujuan tunggal yang memandu pekerjaan selama Sprint.

Setelah itu, tim membahas apa yang _bisa_ dilakukan untuk mencapai tujuan tersebut. Developers memilih item dari Product Backlog, memperkirakan usaha yang dibutuhkan, dan memecahnya menjadi tugas-tugas kecil yang bisa diselesaikan dalam satu hari. Ini bukan masalah menerima daftar tugas dari orang lain, melainkan pemilikannya penuh oleh Developers.

Hasil dari Sprint Planning adalah _Sprint Backlog_ – kombinasi dari Sprint Goal, item Product Backlog yang dipilih, dan rencana bagaimana item-item itu akan dikerjakan.
