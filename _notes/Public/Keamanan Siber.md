...
1.  **Orang**: Edukasi pengguna tentang praktik keamanan adalah lapisan pertahanan pertama dan paling fundamental.
2.  **Proses**: Membangun kerangka kerja untuk memantau, merespons, dan memulihkan dari insiden keamanan.
3.  **Teknologi**: Menggunakan alat seperti *firewall*, enkripsi, dan perangkat lunak antivirus untuk melindungi infrastruktur.
